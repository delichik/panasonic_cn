"""The Panasonic CN number platform."""
...
async def async_setup_entry(
    ...
    """Set up the Panasonic CN number platform."""
...
class PanasonicCNNumber(NumberEntity, CoordinatorEntity):
    """Representation of a Panasonic CN number entity."""
    ...
    async def async_set_native_value(self, value: float) -> None:
        ...
        await self.coordinator.async_set_number_value(
            self._device.id,
            value,
